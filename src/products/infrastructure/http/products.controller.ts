...
export class ProductsController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new product in the catalog. Requires **admin** or **manager** role.',
  })
  ...
  @ApiResponse({
    status: 403,
    description: 'Insufficient role (customer cannot create products)',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Public endpoint. Returns a paginated list of products. Supports filtering by category, status, and price range, plus sorting.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Public endpoint. Returns the full product data for the given MongoDB ObjectId.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Partial update of a product. All fields are optional. Requires **admin** or **manager** role.',
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ObjectId of the product',
  ...
  @ApiResponse({
    status: 403,
    description: 'Insufficient role (manager and customer cannot delete)',
  })
  @ApiResponse({ status: 404, description: 'Product not found' })
